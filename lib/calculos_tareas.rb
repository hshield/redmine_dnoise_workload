class CalculosTareas
  ...
  def initialize(id, finicio, ffin, hasignadas, hdedicadas, realizado, priority, factual = 0, parent = false)
    ...
    @dias_grises = {}
    @dias_restar = {}
    @hdias_restantes = @datetools.stimated_days(@hrestantes, @dias_restantes);	# hours / day
...
#puts "get_load_by_day:"
#puts " - id: " + @id.inspect + ", dia: " + dia.inspect + ",finicio: " + @finicio.inspect + ", ffin: " + @ffin
#puts " - dias_grises: " + @dias_grises.inspect
#puts " - hdias_restantes: " + @hdias_restantes.inspect
#puts " - factual: " + @factual.inspect
#puts " - dias_azules: " + @dias_azules.inspect
#puts " - dias_restar: " + @dias_restar.inspect
#puts " - dias_y_time_restantes: " + @dias_y_time_restantes.inspect
...
#puts "TimeDaysIssues"
#puts " - id: " + @id.inspect
#puts " - num_dias: " + num_dias.inspect + ", horas_al_dia: " + horas_al_dia.inspect + ", start_date: " + start_date.inspect
